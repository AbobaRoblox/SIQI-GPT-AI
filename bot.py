...
TELEGRAM_BOT_TOKEN = "8292994808:AAGGzb0ACr1oPEw7hq4sxyeavyJqpAhvncI" #Вставте Ваш Телеграм-бот Токен
OPENROUTER_API_KEY = "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" #Вставте ваш OpenRouter API-ключ
...
async def send_welcome(message: types.Message):
    ...
    await message.reply("Привет! Отправь мне сообщение, и я постараюсь ответить с помощью новейшей модели SIQI GPT v1")
